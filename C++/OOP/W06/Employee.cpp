...
Employee::Employee(std::string name, int yearIn, float baseSalary, std::string ID, int birthMonth) : name(name), yearIn(yearIn), baseSalary(baseSalary), ID(ID), birthMonth(birthMonth){
...
void Employee::setYearIn(int yearIn){
    this->yearIn = yearIn;
}
