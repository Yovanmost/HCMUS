...
// 	matricBoard[4][1].value = 2;	matricBoard[4][2].value = 3;	matricBoard[4][3].value = 4;	matricBoard[4][4].value = 1;
...
Points** newMatric(int n){ // n = 4x4 8x8 or 16x16; 
	...
	matricBoard[1][1].value = 1;	matricBoard[1][2].value = 2;	matricBoard[1][3].value = 3;	matricBoard[1][4].value = 4;
	matricBoard[2][1].value = 3;	matricBoard[2][2].value = 1;	matricBoard[2][3].value = 4;	matricBoard[2][4].value = 3;
	matricBoard[3][1].value = 3;	matricBoard[3][2].value = 3;	matricBoard[3][3].value = 1;	matricBoard[3][4].value = 4;
	matricBoard[4][1].value = 1;	matricBoard[4][2].value = 3;	matricBoard[4][3].value = 4;	matricBoard[4][4].value = 1;
	
    matricBoard[1][1].state = SEL;	matricBoard[1][2].state = DEL;	matricBoard[1][3].state = NOR;	matricBoard[1][4].state = SEL;
	matricBoard[2][1].state = NOR;	matricBoard[2][2].state = NOR;	matricBoard[2][3].state = DEL;	matricBoard[2][4].state = NOR;
    matricBoard[3][1].state = NOR;	matricBoard[3][2].state = NOR;	matricBoard[3][3].state = NOR;	matricBoard[3][4].state = NOR;
    matricBoard[4][1].state = NOR;	matricBoard[4][2].state = NOR;	matricBoard[4][3].state = SEL;	matricBoard[4][4].state = SEL;
...
int myLine(Points** matrix, Points p1, Points p2){
    ...
    if (p1.x == p2.x)
        if (checkLineX(matrix, p1.y, p2.y, p1.x))
            // return some kind of signal to change the state of 2 selected points
    if (p1.y = p2.y)
...
/*
    CHANGE THE STATE
    */
void changeState(Points matrix, Points &p1, Points &p2){
    p1.state = DEL;
    p2.state = DEL;
    p1.value = 0;
    p2.value = 0;
...
//	cin >> n;
    ...
    if (checkMoreLineX(a, a[4][4], a[1][4], 1) >0)
        cout << "Yeh More";
    else cout << "Yah";
