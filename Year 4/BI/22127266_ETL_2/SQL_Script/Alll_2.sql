/*
================================================================================
SCRIPT TÁI TẠO TOÀN BỘ CSDL (ERP, CRM, Stage, NDS, DQ, Metadata)
================================================================================
Lưu ý: Script này sẽ XÓA SẠCH toàn bộ dữ liệu hiện có trong các CSDL này.
Chỉ chạy trên môi trường test/dev.
*/
...
-- =============================================
-- 3. Xóa và tạo lại Database: Stage
-- =============================================
USE master;
GO
...
-- =============================================
-- 6. Xóa và tạo lại Database: ETL_Metadata
-- =============================================
USE master;
GO
...
-- );
-- GO
-- -- Chèn mốc watermark ban đầu để ETL có thể chạy lần đầu tiên
-- INSERT INTO ETL_Watermark (SourceSystem, EntityName, LastSuccessfulLoad, CurrentLoad)
-- VALUES
-- ('ERP_CRM', 'Booking', '1900-01-01', NULL);
-- GO
...
PRINT 'Tất cả 6 CSDL đã được xóa và tạo lại thành công!';