...
def run_add_user_test(base_url, browser_name):
    ...
    try:
        ...
        for index, row in df.iterrows():
            ...
            print(f"\n[🧪] {browser_name.upper()} → Adding user '{user_email}'")
            ...
            try:
                ...
                driver.find_element(By.ID, "failed_login_attempts").clear()
                driver.find_element(By.ID, "failed_login_attempts").send_keys(str(row['Failed Login Attempts']))
                ...
                try:
                    ...
                    print("[❌] No alert shown after submitting.")
                    results.append({
                        "Browser": browser_name,
                        "Email": user_email,
                        "Result": "Fail",
        ...
        driver.quit()
        output_file = os.path.join(BASE_DIR, f"results_users_{browser_name}.csv")
...
if __name__ == "__main__":
    for browser in ["edge"]:
        ...
        run_add_user_test(
            base_url="https://practicesoftwaretesting.com/admin/users/add",
